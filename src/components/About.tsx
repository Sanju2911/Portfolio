      ...
      <div ref={ref} className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-7">
            ...
            >
              "The best digital products are the ones you don't notice —
              they simply work, feel right, and leave you wanting more."
            </blockquote>
            ...
            >
              <p className="hover:text-white/65 transition-colors duration-500">
                I'm Alex Mercer, a full-stack developer and product designer based in San Francisco.
                Over eight years I've shipped digital products for startups, scale-ups, and global
                brands — from consumer apps to complex enterprise platforms.
              </p>
              <p className="hover:text-white/65 transition-colors duration-500">
                My work lives at the intersection of engineering and design. I obsess over the
                details others overlook: the 200ms animation that makes a transition feel alive,
                the information architecture that makes complex data feel simple, the code
                structure that makes future change painless.
              </p>
            </div>
          ...
          >
            ...
            <p className="mt-3 text-[10px] text-white/20 tracking-widest uppercase hover:text-white/40 transition-colors duration-300">
              San Francisco, CA — Available 2025
            </p>
          </div>
        </div>
      </div>
